...
export default function AISmartInterview() {
    ...
    const fetchQuestions = async () => {
      try {
        const res = await fetch(
          `https://ai-interview-prep-blgp.onrender.com/session/questions/${sessionId}`,
        );
  ...
  const submitAnswerToServer = async () => {
    try {
      ...
      await fetch(
        `https://ai-interview-prep-blgp.onrender.com/session/answer/${sessionId}`,
        {
          method: "POST",
          headers: {
    ...
    if (currentIndex < questions.length - 1) {
      ...
      try {
        ...
        const res = await axios.get(
          `https://ai-interview-prep-blgp.onrender.com/session/evaluate/${sessionId}`,
          {
            headers: {
              "Content-Type": "application/json",
